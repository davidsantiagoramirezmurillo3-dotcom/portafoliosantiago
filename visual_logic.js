...
registerOnClick('plano 1', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 2.0', 'eje 1.0', 1, function() {}, 0);
}, function(event) {});
registerOnClick('plano 2', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 2', 'eje 2', 1, function() {}, 0);
}, function(event) {});
registerOnClick('plano 3', false, false, [0,1,2], false, function(event) {
    zoomCamera('plano 3', 1, function() {});
}, function(event) {});
registerOnClick('plano 4', false, false, [0,1,2], false, function(event) {
    zoomCamera('plano 4', 1, function() {});
    registerOnClick('plano 5', false, false, [0,1,2], false, function(event) {
        zoomCamera('mesa', 1, function() {});
    }, function(event) {});
}, function(event) {});
registerOnClick('Plano boton', false, false, [0,1,2], false, function(event) {
    tweenCamera('camara 2', 'eje 2', 1, function() {}, 0);
}, function(event) {});
